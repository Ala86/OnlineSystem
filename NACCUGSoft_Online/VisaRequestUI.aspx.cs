        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
          //  string mcode = Request.Form["mcode"];
            ...
            if (mcode.Text != string.Empty && fname != string.Empty && lname != string.Empty && phonenumber != string.Empty && ddate.ToString() != string.Empty)
            {
                ...
                con.Open();
                string query = "insert into OnlineVisaRequest ( empNo ,fname ,mname,lname,title,telephone,trandate,purpose,maddress,ccustcode)  values ('" + enumber + "','" + fname + "','" + mname + "','" + lname + "','" + jobtitle + "','" + phonenumber + "','" + ddate + "','" + purpose + "','" + address + "','" + mcode.Text + "')";
        ...
        private void sms()
        {
           ...
           //  DANGER!This is insecure.See http://twil.io/secure
            ...
            var message = MessageResource.Create(
                body: "Alagie Kuyateh is testing the Online Platform for Ndembalanteh! Powered by New Vision Technologies Ltd",
