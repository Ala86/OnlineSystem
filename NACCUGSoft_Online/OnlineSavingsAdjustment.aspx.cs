...
{
    public partial class OnlineSavingsAdjustment : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //    SqlConnection con = new SqlConnection(connStr);
            //    con.Open();
            //    string query = "insert into OnlineSavingsAdjustment (EmpNo,fname,mname,lname,title,phone,trandate,amount,ccustcode) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + DropDownList1.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "')";
