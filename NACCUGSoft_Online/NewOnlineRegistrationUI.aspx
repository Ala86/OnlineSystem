...
<body>
 ...
 <section class="navigation">
  <div class="nav-container">
    <div class="brand">
      <a href="DashboardUI.aspx">DASHBOARD - GPFCCU Online</a>
    </div>
    ...
    <form id="form1" runat="server">
        ...
        <div id="container">
            <p>
                <label>
                    Member Number<br>
                       <asp:TextBox ID="ccustcode" name ="ccustcode"  runat="server" Enabled="False"></asp:TextBox>
                </label>
                    <label>
                    Employee Number<br>
                    <input type="number"  id ="mempnumber" name ="mempnumber" placeholder=" "> 
                </label>
                <label>
                    First Name<br>
