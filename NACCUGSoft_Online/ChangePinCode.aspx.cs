    ...
    public partial class ChangePinCode : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox2.Text.Trim() == TextBox3.Text.Trim())
            {
                ...
                con.Open();
                string query = "update person set pinnumber = '" + TextBox3.Text + "' where (select distinct number from Customer where person.PersonID = Customer.CustomerID) = '" + Global.GlUserNames + "'";
