<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CUSavingsAdjustment.aspx.cs" Inherits="NACCUGSoft_Online.CUSavingsAdjustment" %>
...
<body>
  ...
  <div class="nav-container">
    ...
    <form id="form1" runat="server">
     <h2>Online Savings Adjustment</h2>
<div id='container' style='width: 100%;'> 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NACCUDATAConnectionStringALA %>" DeleteCommand="DELETE FROM [OnlineSavingsAdjustment] WHERE [custcode] = @custcode" InsertCommand="INSERT INTO [OnlineSavingsAdjustment] ([EmpNo], [fname], [mname], [lname], [title], [phone], [trandate], [amount], [remarks], [checked], [ccustcode]) VALUES (@EmpNo, @fname, @mname, @lname, @title, @phone, @trandate, @amount, @remarks, @checked, @ccustcode)" SelectCommand="SELECT * FROM [OnlineSavingsAdjustment]" UpdateCommand="UPDATE [OnlineSavingsAdjustment] SET [EmpNo] = @EmpNo, [fname] = @fname, [mname] = @mname, [lname] = @lname, [title] = @title, [phone] = @phone, [trandate] = @trandate, [amount] = @amount, [remarks] = @remarks, [checked] = @checked, [ccustcode] = @ccustcode WHERE [custcode] = @custcode">
            <DeleteParameters>
        ...
        <asp:Button ID="Button1" runat="server" CssClass="auto-style4" PostBackUrl="~/MainMenu.aspx" Text="Return to Mainmenu" />
        </div>
    </form>
        <footer>
