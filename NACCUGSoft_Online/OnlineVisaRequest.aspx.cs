...
{
    public partial class OnlineVisaRequest : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    Combtitle();
            //}
            //TextBox8.Text = Global.GlUserNames;
        ...
        {
            //if (TextBox2.Text != string.Empty && TextBox4.Text != string.Empty && TextBox5.Text != string.Empty && TextBox6.Text != string.Empty && TextBox7.Text != string.Empty)
            //{
            //    string connStr = ConfigurationManager.ConnectionStrings["myConnectionString"].ConnectionString;
            //    SqlConnection con = new SqlConnection(connStr);
            //    con.Open();
            //    string query = "insert into OnlineVisaRequest ( empNo ,fname ,mname,lname,title,telephone,trandate,purpose,maddress,ccustcode)  values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + DropDownList1.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + DropDownList4.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "')";
